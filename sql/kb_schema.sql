...
create unique index if not exists uniq_kb_docs_src_date on public.kb_docs (source_url, date);
...
-- RLS: anon read-only for KB, edit with service role via Edge
